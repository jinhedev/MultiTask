...
//  MultiTask
//
//  Created by rightmeow on 11/26/17.
...
public enum UICollectionViewWaterfallLayoutItemRenderDirection: Int {
...
public  let UICollectionElementKindSectionHeader = "UICollectionElementKindSectionHeader"
public  let UICollectionElementKindSectionFooter = "UICollectionElementKindSectionFooter"
...
class UICollectionViewWaterfallLayout: UICollectionViewLayout {
    ...
    public var itemRenderDirection: UICollectionViewWaterfallLayoutItemRenderDirection {
        didSet {
            invalidateLayout()
        }
    }
    ...
    public weak var delegate: UICollectionViewDelegateWaterfallLayout? {
        get {
            return self.collectionView!.delegate as? UICollectionViewDelegateWaterfallLayout
        }
    }
    ...
    override public init() {
        ...
        self.itemRenderDirection =
            UICollectionViewWaterfallLayoutItemRenderDirection.UICollectionViewWaterfallLayoutItemRenderDirectionShortestFirst
